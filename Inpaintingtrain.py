...
from Inpaintingtrainer import Trainer
from Inpaintingdataset import Dataset
from Inpaintingtools import get_config, random_bbox, mask_image, get_logger

parser = ArgumentParser()
parser.add_argument('--config', type=str, default=r'C:\config.yaml.txt', help="training configuration")
